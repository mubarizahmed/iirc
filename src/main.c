...
#define LED_STRIP1_R GPIO_NUM_35
...
static void example_ledc_init(void) {
    ...
    ledc_channel_config_t ledc_channel = {
        ...
        .duty = 80, // Set duty to 0%
        .hpoint = 0};
    ESP_ERROR_CHECK(ledc_channel_config(&ledc_channel));

    gpio_set_direction(LED_STRIP1_G, GPIO_MODE_OUTPUT);
    gpio_set_direction(LED_STRIP1_R, GPIO_MODE_OUTPUT);
...
#define EXAMPLE_IR_TX_GPIO_NUM 26
#define EXAMPLE_IR_RX_GPIO_NUM 25
